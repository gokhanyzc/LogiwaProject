...
{
    public class MongoDbLogiwaDbSchemaMigrator : ILogiwaDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbLogiwaDbSchemaMigrator(IServiceProvider serviceProvider)
        {
